...
def generate_summarized_pdf(txt_path, output_pdf_path):
    ...
    # Function to generate a structured, concise summary using Gemini
    def generate_summary(chunk):
        ...
        **Format the summary as follows:**
        ...
        if response and hasattr(response, "content"):
            ...
            summary_text, key_points_text = response_text.split("**Key Points**:") if "**Key Points**:" in response_text else (response_text, "")
    ...
    llm = ChatGoogleGenerativeAI(model="gemini-pro", api_key=GEMINI_API_KEY, temperature=0.3, top_p=0.7, max_tokens=300)  # Reduced tokens
